...
- **Home Route**
  ...
  - **Header**
    ...
    - When the user is on the Search Route, the search input field should be displayed with the search button. When the search icon button is clicked, the search API should be triggered
    - When the **Profile** logo in the header is clicked, then the page should be navigated to the Account Route
    - The active route link should be highlighted in the header
...
- **Account Route**
  ...
  - When an authenticated user opens the Account Route
    ...
    - The username which was provided in the login, should be displayed (retrieved from `localStorage`)
    - The password which was provided in the login, should be displayed in masked format (retrieved from `localStorage`)
    - The plan details (Premium, Ultra HD) should be displayed
...
- Third party packages to be used to achieve the design or functionality
  ...
  - React Slick
    ...
    - Import the slick-carousel CSS files directly in the component:
  ...
  - Use `react-spinners` package for loading indicators. Use `BeatLoader` and `ClipLoader` from `react-spinners`.
...
- **Note:**
  ...
  - Use **functional components** with **React hooks** (`useState`, `useEffect`) for all components.
  - Refer to the below Example for the usage of `data-testid` in the HTML elements.

    - Example: `<div data-testid="movieItem" className="movie-item"/>`.
...
- Wrap the `Loader` component with an HTML container element and add the `data-testid` attribute value as **loader** to it
  ...
  - Use `BeatLoader` from `react-spinners` for Home, Popular, and Search routes
  - Use `ClipLoader` from `react-spinners` for Movie Item Details and ReactSlick components
...
- **Login Route**
  ...
  - The username and password should be stored in `localStorage` using the keys `username` and `password` respectively (for display in the Account Route)
...
- **Search Route**
  ...
  - The HTML button element with search icon in the header should have the `data-testid` attribute value as **searchButton** to it
...
- **Header**
  ...
  - `HiOutlineSearch` icon from `react-icons/hi` should be used for the **Search Icon** button in the `MoviesSearch` component (rendered inside Header)
  - The HTML button element with search icon should have the `data-testid` attribute value as **searchButton** to it

- **Footer**

  - `FaGoogle` icon from `react-icons/fa` should be used for the **Google Icon** button in Footer
  - `FaTwitter` icon from `react-icons/fa` should be used for the **Twitter Icon** button in Footer
  - `FaInstagram` icon from `react-icons/fa` should be used for the **Instagram Icon** button in Footer
  - `FaYoutube` icon from `react-icons/fa` should be used for the **Youtube Icon** button in Footer
